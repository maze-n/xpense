...
<template>
    <v-btn style="margin-top: 20px;" @click="() => showDialog = true" color="surface-variant" text="Add Expense"
        variant="outlined"></v-btn>
    <v-dialog max-width="500" v-model="showDialog">
        <v-card title="Add Expense">
            <v-form @submit="handleCreateExpense" :disabled="isLoading">
                <v-container>
                    <v-row>
                        <v-col cols="12" md="12">
            ...
            <v-card-actions>
                ...
                <v-btn text="Create" @click="handleCreateExpense" />
            </v-card-actions>
        </v-card>
    </v-dialog>
